...
if __name__ == "__main__":
    ...
    ligands_dir = os.path.join(parent_dir, f"docking/{pdbid}/experiment_epoch_{epoch}_mols_{num_gen}_bs_{known_binding_site}_pdbid_{pdbid}/ligands")
    images_dir = os.path.join(parent_dir, f"docking/{pdbid}/experiment_epoch_{epoch}_mols_{num_gen}_bs_{known_binding_site}_pdbid_{pdbid}/output_images")
    ...
    sdf_folder_to_smiles_and_images(ligands_dir, images_dir)
